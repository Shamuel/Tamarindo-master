Public Class RegistroEmpleado
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            ...
            Dim instruccionSQL As String
            instruccionSQL = "select * from CLIENTES where CEDULA =" & TextBox1.Text

            DataGridView1.DataSource = ""
            adaptador = New SqlClient.SqlDataAdapter(instruccionSQL, conexion)
            adaptador.Fill(set_de_datos, "CLIENTES")
            DataGridView1.DataSource = set_de_datos.Tables("CLIENTES")
            ...
            Try
                If DataGridView1.Rows.Count > 1 Then
                    ...
                    'Define comando SQL
                    instruccionSQL = "update CLIENTES set NOMBRE ='" & TextBox2.Text & "', DIRECCION = '" & TextBox3.Text & "', CORREO_ELECTRONICO = '" & TextBox4.Text & "', PROVINCIA = '" & ComboBox1.Text & "' WHERE CEDULA = '" & TextBox1.Text & "'"
                    Dim comando As New SqlClient.SqlCommand(instruccionSQL, conexion)
                    comando.ExecuteNonQuery()
                    MessageBox.Show("DATOS ACTUALIZADOS!", "MENSAJE DEL SISTEMA",
       MessageBoxButtons.OK, MessageBoxIcon.Asterisk)
